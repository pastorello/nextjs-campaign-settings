...
import { deleteDhDomainCardById } from "@/app/lib/data/dhDomainCards/deleteDhDomainCardById";

// SPEC-021 T3 — a Daggerheart domain card.
export async function DELETE(
  ...
  try {
    await deleteDhDomainCardById(id);
  } catch (error) {
