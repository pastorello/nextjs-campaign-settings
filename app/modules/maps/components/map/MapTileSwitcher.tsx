...
import { TILE_PROVIDERS } from "@/app/modules/maps/constants/tile-providers";
  ...
  const layerOptions = [
    {
      id: "osm",
      label: "Basic",
      image: "/leaflet/images/map-basic.png",
      provider: TILE_PROVIDERS.find((p) => p.id === "osm"),
    },
    {
      id: "satellite",
      label: "Satellite",
      image: "/leaflet/images/map-satellite.png",
      provider: TILE_PROVIDERS.find((p) => p.id === "satellite"),
    },
    {
      id: "dark",
      label: "Dark",
      image: "/leaflet/images/map-dark.png",
