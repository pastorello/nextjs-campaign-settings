...
- **Rich text in descriptions.** Specified as [SPEC-019](./specs/019-formatted-text.md) and in progress: the sanitiser, stored format ([ADR-0016](./adr/0016-formatted-text-as-sanitised-html.md)) and formatted renderer landed 2026-09-19 (T1–T2); the editor and the field switch are T3–T5.
