...
## Index of every closed item

The summary table's closed rows, moved out of [`TECH_DEBT.md`](./TECH_DEBT.md) on
2026-09-22 so that file holds the work queue alone. Verbatim, in register order.
...
## The 2026-09 sweep — TD-78 through TD-146

Fifty write-ups moved here on 2026-09-22, in the order they stood in the register.
They cover SPEC-016/017's map work, the September quality and accessibility sweep,
and the copy pass — everything found while building Phase 4 and closed before it.
