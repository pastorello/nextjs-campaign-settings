...
| `map.spec.ts`          | Map loads, tile/world switching works, right-click opens the context menu.                                                           | ✅ mount + world switching + context menu; POI/marker CRUD split out to their own specs (TD-46) |
| `map-poi-crud.spec.ts` | "My Places" POI panel: add → appears in list → edit → delete → gone.                                                                 | ✅ TD-46 first sub-slice (2026-08-04)                                                           |
